...
In step 3 of the __answer__ part, I used a weak-convergence argument: $Y_n\sim G_n$ and $Y\sim G$ with $Y_n\Rightarrow Y$. Since $F$ is bounded and $P(Y\in\text{DISC}(F))=0$(because $F$ and $G$ have no common discontinuities) the extended Portmanteau/continuous-a.s. lemma gives $E(F(Y_n))\to E(F(Y))$.
